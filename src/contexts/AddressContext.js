...
const AddressContextProvider = (props) => {
    const [fetchedAddresses, fetchedDispatch] = useReducer(addressReducer, []);
    ...
    return ( 
        <AddressContext.Provider value={{addresses, countries, fetchedAddresses, dispatch, fetchedDispatch}}>
            {props.children}
